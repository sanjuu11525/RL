...
class DQNNet(nn.Module):
    def __init__(self):
        ...
        # self.model = nn.Sequential( nn.Linear(2      , layer_a), nn.LeakyReLU(negative_slope=0.1, inplace=True),
        #                             nn.Linear(layer_a, layer_b), nn.LeakyReLU(negative_slope=0.1, inplace=True),
        #                             nn.Linear(layer_b, layer_a), nn.LeakyReLU(negative_slope=0.1, inplace=True),
        #                             nn.Linear(layer_a, 3      ), nn.LeakyReLU(negative_slope=0.1, inplace=True))
